...
public class CharParser {
	private static int[] mPYValue = new int[] {-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,  
	...
	private static String[] mPYStr = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",  
	...
	public static int getASCII(String chinese) {
		int ascii = 0;
		byte[] bytes = null;
		try {
	...
	public static String convert(String str) {
		...
		if (ascii > 0 && ascii < 160) {
			retStr = String.valueOf((char)ascii);
		} else {
			for (int i = (mPYValue.length - 1); i >= 0; i--) {
				if (mPYValue[i] <= ascii) {
					retStr = mPYStr[i];
					break;
				}
